...
# Paso: Añadir zona "marisma.local" en /etc/bind/named.conf.local
...
# Paso: Configurar /etc/proftpd/tls.conf con certificados y TLSRequired on
# Paso: Descomentar Include de tls.conf en proftpd.conf
